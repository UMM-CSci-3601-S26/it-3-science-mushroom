...
describe('ReportGeneratorComponent', () => {
  ...
  const mockInventory: Inventory[] = [
    ...
    { internalID: "2", internalBarcode: "ITEM-00002", item: 'Pants', description: 'Understocked Pants', brand: 'Adidas', color: 'Blue', size: 'L', type: 'Bottom', material: 'Polyester', packageSize: 2, quantity: 5, maxQuantity: 10, minQuantity: 7, calculatedMinQuantity: 0, stockState: "Under-Stocked", calculatedStockState: "N/A",  notes: '' },
    { internalID: "3", internalBarcode: "ITEM-00003", item: 'Shirt', description: 'Overstocked Shirt', brand: 'Nike', color: 'Red', size: 'M', type: 'Top', material: 'Cotton', packageSize: 1, quantity: 12, maxQuantity: 10, minQuantity: 0, calculatedMinQuantity: 0, stockState: "Over-Stocked", calculatedStockState: "N/A",  notes: '' },
