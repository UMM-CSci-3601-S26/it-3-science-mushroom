...
public class SupplyListController {
  ...
  /**
   * Add a new Supply List to the database based on the JSON body of the request, which must include at least school, grade,
   * and item fields. The method validates the input and returns a 201 Created status if successful.
   * The new Supply List's ID is generated by MongoDB and returned in the response body as JSON.
   * @param ctx
   */
